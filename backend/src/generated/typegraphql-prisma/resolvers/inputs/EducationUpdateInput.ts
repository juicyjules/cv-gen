...
import { CVUpdateManyWithoutEducationNestedInput } from "../inputs/CVUpdateManyWithoutEducationNestedInput";
...
export class EducationUpdateInput {
  ...
  @TypeGraphQL.Field(_type => CVUpdateManyWithoutEducationNestedInput, {
    nullable: true
  })
  CV?: CVUpdateManyWithoutEducationNestedInput | undefined;
}
